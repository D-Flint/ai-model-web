...
export const OFFICIAL_PROVIDER_SPECS: Record<string, OfficialProviderSpec> = {
  ...
  'o1-mini': {
    ...
    defaultEffort: 'fixed',
    lastVerifiedAt: '2026-09-14',
    sourceUrl: 'https://developers.openai.com/api/docs/models/o1-mini',
    sourceName: 'OpenAI Official Documentation',
  },
  'o3-mini': {
    slug: 'o3-mini',
    ...
    defaultEffort: 'medium',
    lastVerifiedAt: '2026-09-14',
    sourceUrl: 'https://developers.openai.com/api/docs/models/o3-mini',
    sourceName: 'OpenAI Official Documentation',
  },
  'gemini-2-0-flash': {
  ...
  'o1-preview': {
    ...
    defaultEffort: 'fixed',
    lastVerifiedAt: '2026-09-14',
    sourceUrl: 'https://developers.openai.com/api/docs/models/o1-preview',
    sourceName: 'OpenAI Official Documentation',
  },
  'gpt-4o-2024-08-06': {
  ...
  'o4-mini-deep-research': {
    ...
    defaultEffort: 'high',
    lastVerifiedAt: '2026-09-14',
    sourceUrl: 'https://developers.openai.com/api/docs/models/o4-mini-deep-research',
    sourceName: 'OpenAI Official Documentation',
  },
  'o3-deep-research': {
    ...
    defaultEffort: 'high',
    lastVerifiedAt: '2026-09-14',
    sourceUrl: 'https://developers.openai.com/api/docs/models/o3-deep-research',
    sourceName: 'OpenAI Official Documentation',
  },
  'gpt-4-1': {
    slug: 'gpt-4-1',
  ...
  'moonlight-16b-a3b-instruct': {
    ...
    defaultEffort: 'none',
    lastVerifiedAt: '2026-09-06',
    sourceUrl: 'https://github.com/moonshot-ai/Moonlight',
    sourceName: 'Moonshot AI Moonlight Repository',
  },
  'moonlight-16b-a3b': {
  ...
  'synlogic-32b': {
    ...
    defaultEffort: 'medium',
    lastVerifiedAt: '2026-09-06',
    sourceUrl: 'https://github.com/MiniMax-AI/SynLogic',
    sourceName: 'MiniMax SynLogic Repository',
  },
  'synlogic-7b': {
    slug: 'synlogic-7b',
    releaseDate: '2025-05-25',
...
> = {
  'gemini-3-1-pro': {
    value: 1_048_576,
    source: {
      id: 'google-gemini-3-1-pro-context',
      name: 'Gemini 3.1 Pro model limits',
      url: 'https://ai.google.dev/gemini-api/docs/models/gemini-3.1-pro',
...
for (const [slug, input, output, cached, storage] of [
  ...
  ['gemini-3-7-flash', 0.75, 3.75, 0.075, 0.5],
  ['gemini-3-6-flash', 0.75, 3.75, 0.075, 0.5],
  ['gemini-3-5-flash', 1.5, 9, 0.15, 1],
  ['gemini-3-5-flash-lite', 0.3, 2.5, 0.03, 1],
  ['gemini-3-1-pro', 2, 12, 0.2, 4.5],
  ['gemini-3-1-flash-lite', 0.25, 1.5, 0.025, 1],
  ['gemini-3-flash', 0.5, 3, 0.05, 1],
  ['gemini-2-5-flash', 0.3, 2.5, 0.03, 1],
  ['gemini-2-5-flash-lite', 0.1, 0.4, 0.01, 1],
] as const) {
  const isPro = slug === 'gemini-3-1-pro';
  const longInput = 4;
  const longOutput = 18;
  const longCached = 0.4;
