...
for (const [slug, input, output, cached, storage] of [
  ...
  const isPro = slug === 'gemini-3-1-pro' || slug === 'gemini-2-5-pro';
  const longInput = slug === 'gemini-3-1-pro' ? 4 : 2.5;
  const longOutput = slug === 'gemini-3-1-pro' ? 18 : 15;
  const longCached = slug === 'gemini-3-1-pro' ? 0.4 : 0.25;
