...
with sync_playwright() as p:
    ...
    visit("/find")
    page.get_by_role("checkbox", name="Writing", exact=False).check()
    page.get_by_role("button", name="Continue", exact=True).click()
    page.get_by_role("checkbox", name="Best quality", exact=False).check()
    page.get_by_role("button", name="Continue", exact=True).click()
    ...
    page.get_by_role("button", name="Continue", exact=True).click()
    page.get_by_role("button", name="Continue", exact=True).click()
    page.get_by_role("radio", name="Free API", exact=False).check()
    page.get_by_role("button", name="Find my matches").click()
