...
with sync_playwright() as p:
    ...
    expect(page.locator('tbody tr').last).to_contain_text('$0.10 up to 200k · $0.20 above')
    ...
    expect(page.locator('.comparison-table')).to_contain_text('$0.10 up to 200k · $0.20 above')
